...
extern
#endif
double  surf_bond_k,surf_bond_energy,**surf_bond_req,**avg_rho,wall_lamb[4],wall_thick,lam_L,***W_tsn,***vir_func,***vir_funcpp,***vir_funcpg,**q_noise,Diff_rot,*verlet_a,*verlet_b,p_m,**x_bac,**gn_bac,**grf_bf_x, ***epslon,**real_trq,**trq,**euler_ang,***euler_Q,**euler_adot,quantern4,**euler_q,***euler_B,***euler_A,***dAdphi,***dAdtheta,***dAdpsi,**x, **f , *tmp, **grid_W, V, L[Dim], dx[Dim], gvol, Lh[Dim], 
     **rho , **w ,  *r_dudr , *tmp2,*tmp3, 
       ...
       *rhoha, *rhow ,*rhohc, *rhohb, *rhoda, *rhodb , *rhot, *rhop, *smrhop,
       **rhohc_t,**rhoha_t, **rhohb_t, **rhoda_t, **rhodb_t , **rhop_t,
       ...
       *gradwC[Dim],*gradwA[Dim], *gradwB[Dim], *gradwP[Dim], 
...
extern
#endif
int  frame_freq,graft_surf_wait,*surf_bond_flags,*surf_bonds,n_surf_bonds,graft_surface ,wall_para,Nsp ,optm_L, L_dim,L_fren,L_aver,rst_para,uni_sig,nstot, *tp, nA, nB, nC ,nD, Nha, Nhb, Nhc,Nda, Ndb,
